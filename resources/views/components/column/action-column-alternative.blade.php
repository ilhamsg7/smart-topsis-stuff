...
<button type="button" class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $row['id'] }}"><i class="fa fa-trash"></i></button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('alternatives.destroy', $row['id']) }}" method="POST">
                    @method('DELETE')
                    @csrf
